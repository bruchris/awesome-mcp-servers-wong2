...
- **[Canvas LMS MCP](https://github.com/bruchris/canvas-lms-mcp)** - TypeScript MCP server for Canvas LMS with 95 tools across 20 domains. Courses, assignments, submissions, rubrics, quizzes, grading, discussions, modules, pages, files, calendar, analytics, and more. Supports stdio, HTTP, and library import. [![npm](https://img.shields.io/npm/v/@bruchris/canvas-lms-mcp)](https://www.npmjs.com/package/@bruchris/canvas-lms-mcp)
